package com.mandal.myapplication;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_llogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast toast = Toast.makeText(context, combined, duration);
// to show the toast
                toast.show();
                ...
                if(checklogin == true){
                    ...
                    Intent intent=new Intent(Login.this,menu.class); // redirecting to LoginActivity.
                    startActivity(intent);
                }else{
